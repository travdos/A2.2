...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210918_halshardware_d2cc654f7b95218b3249_20210918055657_archive.zip';
	const ARCHIVE_SIZE		 = '100058877';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'd2cc654-18055657';
    const SECONDARY_PACKAGE_HASH = '12c6f54-18055657';
	const VERSION			 = '1.4.3';
