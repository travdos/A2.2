...
if ( ! function_exists( 'exs_get_root_colors_inline_styles_string' ) ) :
	function exs_get_root_colors_inline_styles_string() {
		...
		if ( ! is_admin() ) :
			...
			$exs_css_vars_string .= exs_option( 'main_gap_width', '' ) ? (int) ( exs_option( 'main_gap_width', '' ) ) . 'rem;' : '2.5rem;';

			//buttons font size
			$exs_css_vars_string .= '--btn-fs:';
			$exs_css_vars_string .= exs_option( 'buttons_fs', '' ) ? (int) ( exs_option( 'buttons_fs', '' ) ) . 'px;' : '.92em;';
