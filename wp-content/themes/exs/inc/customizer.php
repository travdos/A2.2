		...
		return apply_filters(
			...
			array(
				...
				*/
				...
				//main menu
				'header_menu_options_heading'        => array(
					'type'        => 'block-heading',
					'section'     => 'section_top_nav',
					'label'       => esc_html__( 'Main Menu Options', 'exs' ),
					'description' => esc_html__( 'Options related to the main menu that is located in the Header section.', 'exs' ),
				),
